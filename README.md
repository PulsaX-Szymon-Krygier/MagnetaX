...
The long-term goal is to build a complete game development ecosystem around MagnetaX, not just a rendering library or a collection of engine systems.

This includes the engine itself, an editor, asset workflows, development tools, and the systems needed to build complete games.

MagnetaX is intended to be a general-purpose engine that can be used for different kinds of games rather than being designed around one specific genre or project.

The project aims to keep solutions modern but practical, with clear architecture, understandable code, and as little unnecessary complexity as possible.
...
MagnetaX is licensed under the [Mozilla Public License 2.0](LICENSE)
